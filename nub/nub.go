...
type Uncurried[A any, B any, C any] func(A, B) C

type Curried[A any, B any, C any] func(A) func(B) C

func Curry[A any, B any, C any](fn Uncurried[A, B, C]) Curried[A, B, C] {
